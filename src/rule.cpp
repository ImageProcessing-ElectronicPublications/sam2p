...
char const* Rule::Cache::dumpFileFormat(ff_t FileFormat, co_t Compression)
{
    ...
    {
    case FF_eps:
        return Compression==CO_ZIP ? "PSL3" : "PSL2";
    case FF_pdf:
        return Compression==CO_ZIP ? "PDF1.2" : "PDF1.0";
    case FF_pdfb:
        return Compression==CO_ZIP ? "PDFB1.2" : "PDFB1.0";
    case FF_PSL1:
        return "PSL1";
    case FF_PSLC:
        return "PSLC";
...
char const* Rule::Cache::dumpSampleFormat(Image::sf_t SampleFormat)
{
    ...
    case Image::SF_Gray1:
        return "Gray1";
    case Image::SF_Indexed1:
        return "Indexed1";
    case Image::SF_Mask:
        return "Mask";
    case Image::SF_Transparent2:
        return "Transparent2";
    case Image::SF_Gray2:
        return "Gray2";
    case Image::SF_Indexed2:
        return "Indexed2";
    case Image::SF_Transparent4:
        return "Transparent4";
    case Image::SF_Rgb1:
        return "Rgb1";
    case Image::SF_Gray4:
        return "Gray4";
    case Image::SF_Indexed4:
        return "Indexed4";
    case Image::SF_Transparent8:
        return "Transparent8";
    case Image::SF_Rgb2:
        return "Rgb2";
    case Image::SF_Gray8:
        return "Gray8";
    case Image::SF_Indexed8:
        return "Indexed8";
    case Image::SF_Rgb4:
        return "Rgb4";
    case Image::SF_Rgb8:
    ...
    char const*template_, Rule::OutputRule*or_, Image::SampledInfo *sf, stream_writer_t stream_writer, char const*const*strings)
{
    ...
    while (1)
    {
        ...
        case 'P': /* number of palette bytes (including the transparent color) */
            out << img->getRowbeg()-img->getHeadp();
            break;
        case '0':
        case '1':
        case '2': /* arbitrary, user-defined string */
...
emit_Decode:
        ...
        case 'G': /* PDF 0..1 RGB triplet of the 1st palette color */
            ...
            r=img->getHeadp()+3;
appG:
            div255(out, (unsigned char)r[0]);
            out << ' ';
            div255(out, (unsigned char)r[1]);
            out << ' ';
